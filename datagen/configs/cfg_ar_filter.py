...
language = 'ar'
do_filter = True
data_dir = '../../dataset-stellar/Syn_data_ar_filter/train/train-50k-ar-{i}/'
data_dir_eval = '../../dataset-stellar/Syn_data_ar_filter/eval/eval-1k-ar/'
...
strong_rate = 0.05
oblique_rate = 0.02
font_dir = 'fonts/ar_ttf'
standard_font_path = 'fonts/ar_ttf/Noto_Sans_Arabic.ttf'

# text
text_filepath = 'data/texts_ar.txt'
