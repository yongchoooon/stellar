...
language = 'jp'
do_filter = True
data_dir = '../../dataset-stellar/Syn_data_jp_filter/train/train-50k-jp-{i}/'
data_dir_eval = '../../dataset-stellar/Syn_data_jp_filter/eval/eval-1k-jp/'
...
strong_rate = 0.05
oblique_rate = 0.02
font_dir = 'fonts/jp_ttf'
standard_font_path = 'fonts/jp_ttf/Kozuka_Gothic_Pro_R.ttf'

# text
text_filepath = 'data/texts_jp.txt'
